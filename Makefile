...
pkg/generated/openapi/zz_generated.openapi.go:
	go run vendor/k8s.io/kube-openapi/cmd/openapi-gen/openapi-gen.go --logtostderr -i k8s.io/metrics/pkg/apis/metrics/v1beta1,k8s.io/apimachinery/pkg/apis/meta/v1,k8s.io/apimachinery/pkg/api/resource,k8s.io/apimachinery/pkg/version -p github.com/kubernetes-sigs/metrics-server/pkg/generated/openapi/ -O zz_generated.openapi -h $(REPO_DIR)/hack/boilerplate.go.txt -r /dev/null
...
_output/%/metrics-server: $(src_deps) pkg/generated/openapi/zz_generated.openapi.go
	GOARCH=$* CGO_ENABLED=0 go build -ldflags "$(LDFLAGS)" -o _output/$*/metrics-server github.com/kubernetes-sigs/metrics-server/cmd/metrics-server
...
container-%: pkg/generated/openapi/zz_generated.openapi.go tmpdir
	...
	docker run --rm -v $(TEMP_DIR):/build -v $(REPO_DIR):/go/src/github.com/kubernetes-sigs/metrics-server -w /go/src/github.com/kubernetes-sigs/metrics-server golang:$(GOLANG_VERSION) /bin/bash -c "\
		GOARCH=$(ARCH) CGO_ENABLED=0 go build -ldflags \"$(LDFLAGS)\" -o /build/metrics-server github.com/kubernetes-sigs/metrics-server/cmd/metrics-server"
